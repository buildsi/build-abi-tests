...
ParseVtbl();
// ParseExc();
//  AddHotkey("Ctrl-7","ParseFI");
//  AddHotkey("Ctrl-8","ParseVtbl");
//  AddHotkey("Ctrl-9","ParseExc");
//  Message("Use Ctrl-7 to parse FuncInfo\n");
//  Message("Use Ctrl-8 to parse vtable\n");
//  Message("Use Ctrl-9 to parse throw info\n");
}
#ifndef __INCLUDED
static main(void)
{
